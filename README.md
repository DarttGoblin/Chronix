...
Required Features:
	...
	Customizable Alerts: Set your own reminder times (e.g., 1 hour, 30 minutes before a deadline).
	Task Prioritization: Assign priority levels to tasks based on urgency or importance.
